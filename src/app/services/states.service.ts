...
import { ConditionalRule, EffectRule, State, StatementRule, TransitionRule } from '../shared/models/api';
...
export class StatesService {
  ...
  addConditionalRule(selectedState: State, rule:ConditionalRule): Observable<State>{
  ...
  addStatementRule(selectedState: State, rule:StatementRule): Observable<State>{
    selectedState.statementRules.push(rule);
    this.setSelectedState(selectedState);
    return this.selectedState.asObservable();
  }
  
  addTransitionRule(selectedState: State, rule:TransitionRule): Observable<State>{
